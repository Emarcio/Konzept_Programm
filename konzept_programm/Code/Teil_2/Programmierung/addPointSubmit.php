...
<html>
    ...
    <body class="karte">
        ...
        <div class="map-title">
            <hgroup>
                <h1>Deine <strong class="green-strong">Markierung</strong> wurde übermittelt,</h1>
        ...
        <div id="wrapper-submit">   
            <div id="content-danke">
                <h1 class="h1-locate">Vielen Dank für deine Markierung!</h1>
                <p>Kehre nun zur Karte zurück und begutachte deinen Marker</p>
